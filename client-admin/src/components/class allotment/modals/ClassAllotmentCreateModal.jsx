...
import { createApi } from "../../../apis/class allotment api/api";
...
const ClassAllotmentCreateModal = ({ handleClose }) => {
    ...
    <div className="flex-column align-items-center gap-2">
      ...
      <Collapse in={showStatus} sx={{ width: '100%' }}>
        <Alert color={isSuccess ? "primary" : "error"} severity={isSuccess ? "success" : "error"}>
          {isSuccess ? 'Class allotted successfully' : errorMsg}
        </Alert>
      </Collapse>
      <Formik
...
export default ClassAllotmentCreateModal;