import { Alert, Avatar, Button, Collapse, Divider, Fade, Grow, LinearProgress, MenuItem, Select, TextField, Typography, styled } from "@mui/material";
...
const FacultyTTCreateModal = ({ selectedFaculty, handleClose }) => {
  ...
  return (
    <div className="flex-column align-items-center gap-2">      
      <Fade in={isLoading}>
        <LinearProgress sx={{ width: '100%', borderRadius: '10px', margin: '10px 0px' }} color="secondary" />
      </Fade>
              ...
              <table style={{ width: '600px' }} className="align-cell-text-left">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><MyInputText name="facultyId" /></td>
                  </tr>
                </tbody >
              </table >
            </div>
...
export default FacultyTTCreateModal;